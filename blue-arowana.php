...
<head>
	...
	<meta name="description" content="Blue Arowana Cheap Accommodation Hotels in Port Dickson offers Twin-Sharing Bedrooms & We have the Best Asian Hotel Rooms & provide Beachfront HomeStay Rooms.">
	<title>Blue Arowana | Cheap Accommodation Hotels in Port Dickson</title>
...
<!-- End Google Tag Manager (noscript) -->
	...
	<div class="inner-banner">
		<h4>Blue Arowana I, II and III</h4>
		<div class="site_map">
			<a href="index.php">Home</a>    
			Blue Arowana I, II and III
		</div>
		<div class="clear"></div>
	</div>	
	...
	<div class="wrapper dark">
		...
		<div class="latest mb30">
			<div class="box mb20">
				...
				<div class="box-text">
					<h4>Blue Arowana I, II and III</h4>
					<p>The Blue Arowanas is a three (3) unit adjoining, spacious, self-contained two bedroom

chalets with a cozy and comfortable ambience.  Each unit can be booked on its own or 

all three to cater for a large get together. <br><br>

Each unit also has two cozy twin-sharing bedrooms with attached bathrooms, toilet and 

shower with access to both cold and hot water.  It also has a pantry equipped with 

storage facility; refrigerator and washbasin open to a living room. The living room has a 

beautiful scenic view of the ocean.<br><br>

The chalet is fully air conditioned and is equipped with modern furniture and television
                  </p>
					<!--<ul>
