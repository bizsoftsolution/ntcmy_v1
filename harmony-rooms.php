...
<head>
	...
	<meta name="description" content="Harmony Rooms Business Training Centre Hall in Port Dickson offers Complete Furnished Setting for Parties & We provide Beachfront Corporate Event Hall.">
	<title>Harmony Rooms|Business |Training Centre Hall in Port Dickson</title>
		...
		<div class="latest mb30">
			...
			<div class="box mb20">
				...
				<div class="box-img">
					...
					<img src="images/harmony/har-banner.jpg" alt="">
				...
				<div class="box-text">
					...
					<p>Fifty twin-sharing standard rooms, tastefully furnished with modern and functional 



furnishing, air-conditioned, TV and bathrooms with shower and toilets.  The rooms have 



connecting doors for families and other smaller groups and offer confirm and warmt.  



The rooms on the top most floors attract many for the scenic view of the deep blue sea.<br><br>
