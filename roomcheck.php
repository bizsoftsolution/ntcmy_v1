...
$chinmonth = date("m",strtotime($checkin));
	...
	//echo $chinmonth;
	$disc ="";
	if($chinmonth == '10' || $chinmonth == '11' || $chinmonth == '12'|| $chinmonth == '01'|| $chinmonth == '02'|| $chinmonth == '03'|| $chinmonth == '04' || $chinmonth == '05' || $chinmonth == '06' || $chinmonth == '07' || $chinmonth == '08' || $chinmonth == '09' || $chinmonth == '1'|| $chinmonth == '2'|| $chinmonth == '3'|| $chinmonth == '4' || $chinmonth == '5' || $chinmonth == '6' || $chinmonth == '7' || $chinmonth == '8' || $chinmonth == '9')
	{
                ...
                <tbody>
                <tr>
                <td style="color: red; font-weight: bold; font-size: 16px;"> Rooms  Are Not Available because of renavation.<br>Sorry for inconvenience</td>
                </tr>
                </tbody>
                </table>
                </div>
  ...
  if($roomtypeid==4) 
     {
                ...
                $query_update1 =mysql_query("SELECT * FROM bookingrooms WHERE ((checkin between '".$checkin."' AND '".$checkout."') OR (checkout between '".$checkin."' AND '".$checkout."')) and  roomtypeid='".$roomtypeid."' and  drombed='".$drombed."' and  status='1' and check_out=0");

      }
      else
      {

        $query_update1 =mysql_query("SELECT * FROM bookingrooms WHERE ((checkin between '".$checkin."' AND '".$checkout."') OR (checkout between '".$checkin."' AND '".$checkout."')) and  roomtypeid='".$roomtypeid."'  and  status='1' and check_out=0");
      }          
       ...
       if($roomtypeid==4) 
     {
              ...
              $type =mysql_query("SELECT * FROM roomnotable WHERE roomtypeid='".$roomtypeid."' and  drombed='".$drombed."'");
