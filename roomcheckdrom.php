  ...
  if($roomtypeid==4) 
     ...
     if($date_from==$date_to)
    {
        ...
        else
        {
                        ...
                        {
                           $html.='<p style="font-weight: bold; color: rgb(34, 117, 13); margin-bottom: 0px; text-align: center;"> Member Discount Room</p>';
                        }
                      ...
                      $subtotals[]=$amount*$room_no;
                       ...
                       $total=array_sum($subtotals);
                          ...
                          <table><tr><td style="list-style: outside none none; color: rgb(122, 122, 122); margin-left: 10px; width: 150px;">'.$dds.'&nbsp;'.$checkinday.'</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td Style="width: 110px;" >(   MYR '.number_format($amount, 2, '.', '').'  ) X '.$room_no.'</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>=</td></td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>'.number_format($subtotal, 2, '.', '').'</td></tr></table>
                           </div>';
                    ...
                    {
                       $html.='<p style="font-weight: bold; color: rgb(34, 117, 13); margin-bottom: 0px; text-align: center; border-bottom: 1px dotted;"> </p>';
                    }
