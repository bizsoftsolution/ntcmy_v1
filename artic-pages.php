		...
		<div class="latest mb30">
			...
			<div class="box mb20">
				...
				<div class="box-img">
					...
					<img src="images/artic-banner.jpg" alt="">
				...
				<div class="box-text">
					...
					<p>A small private function room on the first floor of NTC and fully air conditioned.  It can 



house small to medium functions with theater style sitting for approximately 70 pax.    It 



has a quiet ambience and is fully equipped to host educational programmes and small 



Conferences.   It is connect directly to the Solidarity Dorms.
