...
<!-- End Google Tag Manager (noscript) -->
	...
	<div class="wrapper dark">
		...
		<div class="latest mb30">
			<div class="box mb20">
				<div class="box-img">
					<img src="images/facility_gold_page_img.jpg" alt="">
					<a href="#" class="details">Book Now!</a>
				</div>
				<div class="box-text">
					<h4>Golden Arowana</h4>
					<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu <br><br>
                    Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit.<br><br>
