...
<div class="panel panel-default">
            ...
            foreach ($upList as $a) {
               ?>
                <tr>
                   ...
                   <td><?php echo $a['halltype']." ( ".$a['auditorium']." )";?></td>
                    <td><?php echo $a['slot'];?></td>
                    <td><?php echo $a['grandtotal'];?></td>
                    <td><a  class="btn btn-success" data-toggle="modal" href="#hallmovetopaid<?php echo $a['id'];?>">Move To Paid</a></td>
    ...
    <?php 
            ...
            foreach ($upList as $b) :
               ?>
                                <!-- BEGIN # MODAL LOGIN -->
<div class="modal fade" id="hallmovetopaid<?php echo $b['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div id="div-forms">
                    ...
                    <form id="register-form" method="post" action="<?php echo site_url();?>hallbooking/confirmHall" >
