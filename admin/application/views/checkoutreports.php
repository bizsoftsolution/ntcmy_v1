    ...
    <div class="panel-body my-table table-responsive">
        <table class="table datatable ">
            ...
            foreach ($out as $a) {
				...
				@$gettranscationid=$this->db->select('transcation_id')->where('pnr_number',$a['pnrnumber'])->get('bookingrooms')->row()->transcation_id;
               ?>
                <tr>
                    <td><?php echo $i++;?></td>
                    <td><?php echo $a['pnrnumber'];?></td>
                    <td><?php echo $a['checkindate'];?></td>
                    <td><?php echo $a['checkintime'];?></td>
                    ...
                    <td>
                    <a href="<?php echo base_url();?>checkout/viewdetails/<?php echo $a['id'];?>"
                        class="btn btn-primary btn-rounded">View</a>
                       </td>
                       <td>
                    <a target="_blank" href="<?php echo base_url();?>checkout/print_details/<?php echo $a['id'];?>"
