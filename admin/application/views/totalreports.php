...
<div class="panel panel-default">
    ...
    <form name="form" id="from1" method="post" action="<?php echo base_url();?>checkout/totalreports">
              ...
              else
              {
               ...
               ?>
                <tr>
                    ...
                    <td><?php echo date('d-m-Y',strtotime($a['checkindate'])).'/'.$a['checkintime'];?></td>                 
                    <td><?php echo date('d-m-Y',strtotime($a['checkoutdate'])).'/'.$a['checkouttime'];?></td>                  
                    <td><?php echo $a['noofroom'];?></td>
