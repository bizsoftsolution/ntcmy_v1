                ...
                <tr>
                   ...
                   <td><?php echo $a['roomtype'];?></td>
                    <td><?php echo $a['room_no'];?></td>
                     <td><?php echo $a['bookingtype'];?><br><?php if( $a['bookingtype']=='Online Booking'){ if($a['reject_status']=='2'){echo '<span style="color:red; font-weight:bold;">(Reject)</span>';}else{echo '<span style="color:green; font-weight:bold;">(Paid)</span>';}}?></td>
...
<script>
$('#rejectbooking_report').addClass('active');
