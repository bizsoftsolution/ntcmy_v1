...
<table width="650" border="0" align="center" style="border-top:1px solid black; border-left:1px solid black; border-right:1px solid black;  border-collapse: collapse;">
  ...
  <tr>
    <td rowspan="5" valign="top" style="padding:3px;font-family: arial;"><strong><p style="margin-top:-5px; font-size: 14px;"></p>ATTN : <?php echo $a['name'];?> <br />
        <?php echo $a['email'];?><br />
    ...
    <td width="110" align="left"style="padding:3px;font-family: arial; font-size: 14px;"><strong><?php echo $a['billnumber'];?></strong></td>
     ...
     <tr>
    <td height="24" align="right" valign="top"style="font-family: arial; font-size: 14px;">Reservation Number</td>
    <td valign="top">:</td>
    <td align="left" valign="top" style="padding:3px;font-family: arial; font-size: 14px;"><strong><?php echo $a['pnrnumber'];?></strong></td>
  </tr>
    <tr>
...
<table width="650" border="0" align="center"  style="padding:10px;border-left: 1px solid black;border-right: 1px solid black;border-top: 1px dotted black; border-bottom: 1px solid black; font-size:12px;">
  ...
  <td><strong></strong></td>
    ...
    <td  align="right"><?php if($promocodea!=''){?><span>(Using Promocode)</span><?php }?>
