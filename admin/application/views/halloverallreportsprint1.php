...
<table width="900" border="0" align="center" style="border-collapse:collapse; font-family: Arial, Helvetica, sans-serif; font-size: 10px;">
  <tr style="font-size: 12px;">
    ...
    <?php 
            ...
            $dat=$this->db->where('pnrnumber',$a['pnrnumber'])->where('bookingtype','Direct Booking')->get('hallbooking')->result_array();
  ...
  <tr>
    ...
    <td align="left" style="border-bottom:1px dotted black;"><strong><?php echo $c['firstname'].''.$c['lastname'];?></strong></td>
