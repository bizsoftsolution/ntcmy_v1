...
<table width="900" border="0" align="center" style="border-collapse:collapse; font-family: Arial, Helvetica, sans-serif; font-size: 10px;">
  <tr style="font-size: 12px;">
    ...
    <?php 
            ...
            $dat=$this->db->where('status',1)->where('ad_status',1)->where('bookingtype','Online Booking')->get('bookingrooms')->result_array();
  ...
  <tr>
    ...
    <td align="left" style="border-bottom:1px dotted black;"><strong><?php echo $b['firstname'].''.$b['lastname'];?></strong></td>
    ...
    <td align="center" style="border-bottom:1px dotted black;"><strong><?php if($b['nubememberid']==''){ echo 'No';}else{echo 'Yes'; }  ?></strong></td>
    <td align="center" style="border-bottom:1px dotted black;"><strong><?php echo date('d/m/Y',strtotime(str_replace('-', '/', $b['checkin'])));?></strong></td>
    <td align="center" style="border-bottom:1px dotted black;"><strong><?php echo date('d/m/Y',strtotime(str_replace('-', '/', $b['checkout'])));?></strong></td>
    <td align="center" style="border-bottom:1px dotted black;"><strong><?php echo $bookingtype;?></strong></td>
    <td align="right" style="border-bottom:1px dotted black;"><strong><?php echo $b['onlinepayments'];?></strong></td>
  </tr>
     <?php 
   //}
