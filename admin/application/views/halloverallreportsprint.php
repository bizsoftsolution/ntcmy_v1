...
<table width="900" border="0" align="center" style="border-collapse:collapse; font-family: Arial, Helvetica, sans-serif; font-size: 10px;">
  <tr style="font-size: 12px;">
    ...
    <?php 
            ...
            $dat=$this->db->where('status',1)->where('ad_status',1)->where('bookingtype','Online Booking')->get('hallbooking')->result_array();
    ...
    // $dat1=$this->db->where('pnrnumber',$b['pnrnumber'])->get('checkouthall')->result_array();
  ...
  <tr>
    ...
    <td align="center" style="border-bottom:1px dotted black;"><strong><?php echo date('d/m/Y',strtotime(str_replace('-', '/', $b['checkindate'])));?></strong></td>
    <td align="center" style="border-bottom:1px dotted black;"><strong><?php echo date('d/m/Y',strtotime(str_replace('-', '/', $b['checkoutdate'])));?></strong></td>
    <td align="center" style="border-bottom:1px dotted black;"><strong><?php echo $bookingtype;?></strong></td>
    <td align="right" style="border-bottom:1px dotted black;"><strong><?php echo $b['totalamounts'];?></strong></td>
  </tr>
     <?php } //} }?>
