 <!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>                    
                    <li><a href="#">Hall Cancel Reports</a></li>
                    <li class="active">Hall Cancel Reports</li>
                </ul>
                <!-- END BREADCRUMB -->

                <!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Hall Cancel Reports</h2>
                </div>
                <!-- END PAGE TITLE --> 
...
<script>
$('#hall_cancel_reports').addClass('active');
