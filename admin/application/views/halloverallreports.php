...
<div class="panel panel-default">
    ...
    <div class="panel-body my-table table-responsive">
        <table class="table datatable ">
            ...
            $dat=$this->db->where('pnrnumber',$a['pnrnumber'])->get('hallbooking')->result_array();
      ...
      foreach ($dat as $b) 
        ...
        <div style="text-align: center;"><a target="_blank" href="<?php echo base_url();?>overallreports/hallreportsprint"
                        class="btn btn-primary btn-rounded">Online Booking Print</a></div>
<br>
        <div style="text-align: center;"><a target="_blank" href="<?php echo base_url();?>overallreports/hallreportsprint1"
...
<script>
$('#overall_reports1').addClass('active');
