...
<table align="center" width="810" style="border-top:2px solid #222;">
  <tr>
    <td width="300" ><div style="border-bottom:none;width:18%;float:left;">Date :</div><div style="border-bottom:1px solid#222;width:80%;float:left;text-align:center;"><b><?php echo $checkin;?> </b></div></td>
    ...
    <td width="300" style="text-align:right;">PNR No :<b><?php echo $a['pnrnumber'];?></b></td>
  </tr>
</table>
<table align="center" width="810" style="border-radius:05px;margin-top:10px;" >
  <tr style="height:35">
    <td><div style="border-bottom:none;float:left;">Name:&nbsp;</div> <div style="border-bottom:1px dotted#222;width:78%;float:left;"><b><?php echo $a['firstname'];?><?php echo $a['lastname'];?></b></div></td>
    <td>&nbsp;</td>
  </tr>
    <tr style="height:35">
    <td><div style="border-bottom:none;float:left;">Hall Type:&nbsp;</div> <div style="border-bottom:1px dotted#222;width:70%;float:left;"><b><?php echo $a['halltype'];?></b></div></td>
    <td><div style="border-bottom:none;float:left;">Slot:&nbsp;</div> <div style="border-bottom:1px dotted#222;width:42%;float:left;"><b><?php echo $a['slot'];?></b></div></td>
  </tr>
  <tr style="height:35">
     <td><div style="border-bottom:none;float:left;">Online Paid Amount:&nbsp;</div> <div style="border-bottom:1px dotted#222;width:67%;float:left;"><b><?php echo $a['advanceamount'];?></b></div></td>
     <td></td>
  </tr>
  <tr style="height:35" >
