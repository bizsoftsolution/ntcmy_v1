...
$pn = $_GET['s'];
 ...
 $mpdf -> SetDisplayMode('fullpage');
  ...
  $sql = "select * from raw_stock where";

if(!empty($_GET['n'])){
	
	$sql .= " mat_name like '".$_GET['n']."%' and";
...
$result=@mysql_query($sql);
 ...
 <th align="center" style="border-right:1px solid #000; border-bottom:1px solid #000;">Opening</th>
 <th align="center" style="border-right:1px solid #000; border-bottom:1px solid #000;">Production</th>
 <th align="center" style="border-right:1px solid #000; border-bottom:1px solid #000;">Total</th>
 <th align="center" style="border-right:1px solid #000; border-bottom:1px solid #000;">Usage</th>
 <th align="center" style="border-right:1px solid #000; border-bottom:1px solid #000;">Closing</th>
 </tr>'; 
 ...
 <div style="text-align:center"><h3>Raw Materials Stock Report</h3></div><div style="text-align:center;"><b>'.$pn.'</b></div>');
	 $mpdf -> WriteHTML($html);
